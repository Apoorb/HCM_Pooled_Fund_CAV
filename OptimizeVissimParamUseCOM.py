...
def SetStudyApproachVol(new_volume=2000):
    ...
    Filename = os.path.join(
        Path_to_VissimFile,
        "ExtraRuns",
        "VissimBaseModel_Calibration_VolIs {} - V2.inpx".format(new_volume),
    )
    Vissim.SaveNetAs(Filename)
    Filename = os.path.join(
        Path_to_VissimFile,
        "ExtraRuns",
        "VissimBaseModel_Calibration_VolIs {} - V2.layx".format(new_volume),
    )
...
for NewVol in NewVolumes:
    ...
    MultiVISSIM_RunResProcess(
        CommonFileNmWithoutINPX=FileNm, NewVol=NewVol, FileDir1=FileDir
    )
## ========================================================================
# End Vissim
# ==========================================================================
